...
const Footer = (props) => {
    ...
    return (
        <>
            <footer id="react-footer" className={footerClass ? footerClass : 'react-footer home-main'} style={{display:'none'}}>
                ...
                <div className="copyright">  
                    <div className="container">                  
                        <div className="react-copy-left">© 2025 <Link to="/">Aditya University</Link> All Rights Reserved</div>
