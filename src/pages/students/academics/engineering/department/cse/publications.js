...
import ResearchPublications from '../../../commonpages/research-publications';


const MiningResearchPublications = () => {
                                ...
                                <div class="container">
                                    <div className="row ">
                                        <div className="col-6 col-md-4 col-lg-4 col-xl-4">
                                            <h4 className="hedingname_orange mb-4">Publication</h4>
                                        </div>
                                    ...
                                    <div className="row ">
                                        <div className="col-md-12 col-12">
                                            <ResearchPublications year={year} department ={department} />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default MiningResearchPublications ;
