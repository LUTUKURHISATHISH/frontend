...
import AlumniConnectDetails from '../../../commonpages/alumniconnect-details';
const MiningAluminiConnect = () => {
                                ...
                                <div class="container ">
                                    <div className="row ">
                                        <div className="col-md-12 col-12">
                                            <h4 className="hedingname_orange mb-2">Alumni Connect</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="container ">
                                    <div className="row ">
                                        <div className="col-md-12 col-12">
                                            <AlumniConnectDetails department={department} />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default MiningAluminiConnect;
