...
import ResearchProjectDetails from '../../../commonpages/research-projDetails';


const MineResearchProjects = () => {
                                ...
                                <div class="container">
                                    <div className="row ">
                                        <div className="col-6 col-md-4 col-lg-4 col-xl-4">
                                            <h4 className="hedingname_orange mb-4">Projects</h4>
                                        </div>
                                    ...
                                    <div className="row ">
                                        <div className="col-md-12 col-12">
                                            {/* <ResearchProjectDetails year={year} department={department} /> */}
                                            <ResearchProjectDetails  department={department} />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default MineResearchProjects 
