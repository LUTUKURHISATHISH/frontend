...
import FacilitiesClassRoomDetails from '../../../commonpages/facilitiesClassroom-Details';


const MineFacilityClassRoom = () => {
                                ...
                                <div class="container">
                                    ...
                                    <div className="row " id="classroom">
                                        <div className="col-12">
                                            <FacilitiesClassRoomDetails department={department} />
                                        </div>
                                    </div>
...
export default MineFacilityClassRoom
