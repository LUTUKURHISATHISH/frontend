...
import BosMeetingDetails from '../commonpages/bos-meeting';

const MiningBosMeeting = () => {
                                ...
                                <div class="container">
                                    ...
                                    <div className="row ">
                                        <div className="col-md-12 col-12">
                                          <BosMeetingDetails year={year} department = {department} />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default MiningBosMeeting
