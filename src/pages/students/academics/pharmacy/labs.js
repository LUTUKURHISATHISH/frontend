...
import FacilitiesLabsDetails   from '../commonpages/facilitiesLabs-Details';

const MineFacilityLab = () => {
                ...
                <div class="container ">
                    ...
                    <div className="col-md-12 col-sm-12 col-12 bg_color bg-white">
                        ...
                        <div class="container">
                                   ...
                                   <div className="row ">
                                      <FacilitiesLabsDetails department = {department} />
                                   </div>
                        </div>
                    </div>
                </div>
...
export default MineFacilityLab 
